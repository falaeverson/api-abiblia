...
/**
 * Classe que representa as exceções personalizadas.
 * 
...
public class Exception extends RuntimeException {
	...
	public static void checkThrow(boolean expression, ExceptionsMessagesEnum ExceptionsMessagesEnum,
			String... textoDinamico) throws Exception {
