...
import static org.api.abiblia.util.Conversores.buildPage;
...
public class GenericConvert {
	...
	public static <T, E> PageDTO convertWithMappingToPageDefault(Page<T> page, Type typeDestination,
			PropertyMap<T, E> mapping) {
