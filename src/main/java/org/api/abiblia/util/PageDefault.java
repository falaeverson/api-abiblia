...
public class PageDefault extends PageRequest {
	...
	/**
	 * Método responsável por setar os parâmetros nescessários para a solicitação de
	 * uma paginação.
	 * 
	 * @param page  <br/>
	 *              Indica qual página deverá ser retornada; <br/>
	 *              Caso não seja informado nenhum valor para esse parâmetro, será
	 *              assumido como default 0.
	 * @param limit <br/>
	 *              Indica o limite de registros a ser exibido por página; <br/>
	 *              Caso não seja informado nenhum valor para esse parâmetro ou o
	 *              valor informado seja maior que 50, será assumido como default
	 *              50.
	 * 
	...
	public static PageDefault setPageable(Integer page, Integer limit) {
		...
		return (PageDefault) PageDefault.of(page, limit);
	}
