...
public class SwaggerConfig {
	...
	public Docket detalheApi() {
		...
		docket.select().apis(RequestHandlerSelectors.basePackage("br.com.abiblia")).paths(PathSelectors.any()).build()
	...
	private ApiInfoBuilder informacoesApi() {
		...
		// apiInfoBuilder.termsOfServiceUrl("Termo de uso: Deve ser usada para
		// estudos.");
	 ...
	 * 
	 * return new Contact( "Everson Teixeira", "http://www.abiblia.teo.br",
